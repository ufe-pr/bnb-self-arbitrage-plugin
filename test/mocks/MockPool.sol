...
import 'algebra-core/libraries/TickManagement.sol';
import 'algebra-core/libraries/Constants.sol';
import 'algebra-core/libraries/Plugins.sol';
import 'algebra-core/libraries/TickMath.sol';

import 'algebra-core/interfaces/pool/IAlgebraPoolActions.sol';
import 'algebra-core/interfaces/pool/IAlgebraPoolState.sol';
import 'algebra-core/interfaces/pool/IAlgebraPoolPermissionedActions.sol';
import 'algebra-core/interfaces/pool/IAlgebraPoolErrors.sol';
...
contract MockPool is IAlgebraPoolActions, IAlgebraPoolPermissionedActions, IAlgebraPoolState {
  ...
  function communityVault() external pure override returns (address) {
    revert('not implemented');
  }
